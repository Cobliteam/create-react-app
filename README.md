# Cobli Create React App [![Build Status](https://travis-ci.com/Cobliteam/create-react-app.svg?branch=add-typescript)](https://travis-ci.org/Cobliteam/create-react-app)
...
```sh
npx create-react-app my-app --scripts-version=@cobli/react-scripts
cd my-app
yarn start
```
